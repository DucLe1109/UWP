#pragma checksum "H:\Aptech\Kì 3\UWP\uwpSplitView\uwpSplitView\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "8A15EC47A51719356CC2B46BA376C764"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace uwpSplitView
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj8_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::uwpSplitView.Model.NewsItem dataRoot;
            ...
            {
                if (lineNumber == 84 && columnNumber == 57)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::uwpSplitView.Model.NewsItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::uwpSplitView.Model.NewsItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::uwpSplitView.Model.NewsItem obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::uwpSplitView.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::uwpSplitView.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::uwpSplitView.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_NewsItems(global::System.Collections.ObjectModel.ObservableCollection<global::uwpSplitView.Model.NewsItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
